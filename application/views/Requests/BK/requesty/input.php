...
<body>
    <form action="<?php echo base_url(); ?>index.php/request/kaigisho-dt/order_y/input" method="post" id="frm_ordery_input">
<table width="920" border="0" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
      <tr>
        <td class="col3">ドメイン名 <span class="caution">[*]</span></td>
        <td><input name="doain_name" type="text" size="40" /></td>
      </tr>
      <tr>
        <td class="col3">DNS</td>
        <td>大商のDNSを利用（サーバー切り替え作業も大商担当）</td>
      </tr>
      <tr>
        <td class="col3">開通希望日 <span class="caution">[*]</span></td>
      ...
      <tr>
        ...
        <td><font color="#33cc15">「Yコース」●初15,000円／月3,000円</font></td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="col3">SSL証明書</td>
        <td><select name="SSL_certification">
  ...
  <tr>
    <td align="center">
<!--        <img src="btn_check.gif" width="200" height="45" />-->
    <input type="submit" name="submit" value="Submit" <img src="<?php echo base_url();?>img/btn_check.gif" width="200" height="45"/>
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
