...
<body>
<form action="<?php echo base_url(); ?>index.php/request/kaigisho-dt/order_f/input" method="post" id="frm_orderf_input">
<table width="920" border="0" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
      <tr>
        ...
        <td><input name="domain_name" type="text" size="40" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><font color="#ff5050">「Fコース」●初15,000円／月7,000円</font></td>
      </tr>
      <tr>
  ...
  <tr>
    <td align="center"><input type="submit" name="submit" value="Submit" <img src="<?php echo base_url();?>img/btn_check.gif" width="200" height="45"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
